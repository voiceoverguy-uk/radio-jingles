...
## Recent Changes
- 2026-04-14: Full-site SEO & credibility pass — homepage services section expanded to 2-3 sentences; FAQ schema replaced with real PDF answers (turnaround, licensing, WAV/MP3); Community Radio section upgraded; Contact CTA updated; footer adds all service pages; jingles.html gains visible FAQ section + licensing info; all service page FAQs upgraded with real turnaround times (2d spoken/5-10d sung), WAV/MP3 delivery, licensing (2yr sung/1yr spoken/partial inserts), Radiocentre compliance; Organization knowsAbout expanded; metadata titles/descriptions trimmed; studio images converted to WebP (91/50/30KB vs 218/152/124KB JPG); logo-horrible-histories duplicate files deleted
...
public/
  ...
  audio/                           - MP3 demo files
  images/                          - Studio photos and OG image
